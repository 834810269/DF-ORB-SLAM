...
namespace ORB_SLAM2_DENSE
{
            ...
            pcl_plane_(new PointCloudMapping::PointCloud())
    {
        ...
        // get parameters
        private_nh_.param("use_odom_pub", use_odom_pub_, false);
        private_nh_.param("use_tf", use_tf_, false);
        private_nh_.param("use_frame_pub", use_frame_pub_, false);
        private_nh_.param("use_pcl_pub", use_pcl_pub_, false);
